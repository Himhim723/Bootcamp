...
public class datatype{
  ...
  public static void main(String[] args){
    ...
    System.out.print("hello"); //都係顯示資訊，但不同就係顯示完不會幫你去下一行
    System.out.println();      //咩都冇，直接跳下一行
  ...
  /* Primitive Variable             Reference Variable
     no need to know what are the differences between primitive & reference at this moment
  ...
  */
  ...
  //其實加減乘除可混合使用都得，另外佢會跟先乘除後加減 & 同埋括號先後使用次序
  ...
  //唔一樣 所以會顯示 False
  //用黎做咩，例如一份網上考卷，答案係 "Eat",你輸入左 "Damn"
  ...
  System.out.println(letters.charAt(0)); //第一個字母係 0 超重要
  //所以如果想要最後一個字母，我地就會.charAt(25),

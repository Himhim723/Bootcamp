...
* The original package name 'com.vtxlab.demo.helloworld.demo-helloworld' is invalid and this project uses 'com.vtxlab.demo.helloworld.demohelloworld' instead.

...
public class Competition {
   ...
   * 
   * @return All participants joing Team Events are recorded in the data bank of
   *         comp
   */
  ...
  public static void main(String[] args) {
    ...
    Him.setResult400(53.12);
    ABC.setResult400(61.11);
    DEF.setResult400(57.99);
